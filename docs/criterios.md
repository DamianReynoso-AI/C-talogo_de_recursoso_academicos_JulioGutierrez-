...
Estos son los criterios definidos para clasificar un recurso académico dentro del catálogo:

1. **Tipo**: libro, artículo, video, sitio web, herramienta de software.
